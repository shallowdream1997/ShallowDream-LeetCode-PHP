...
class ExportEbaySellerAllocationRecordController
{
    ...
    /**
     * 启用 PHPExcel 磁盘缓存，避免大数据量内存溢出
     * 采用与 ExcelUtils::_readXlsFileV2 一致的缓存策略
     */
    ...
    private function exportToXlsx($allData, $filePath)
    {
        ...
        // 4. 使用 ExcelUtils 导出到当前目录的 export/
        $excelUtils = new ExcelUtils("ebay/");
    ...
    public function handle($pageSize = 500)
    {
        ...
        try {
            ...
            $csvPath = __DIR__ . "/export/" . $csvName;
