...
class CurlService
{
    ...
    public function __construct() {
        ...
        $this->serviceConfig = require dirname(__FILE__) . '/../../config/services.php';
    }
     ...
     * 从 config/services.php 读取配置
     * @return $this
     */
    public function setBaseComponentByEnv(): CurlService
    {
        $env = $this->environment;
        if (isset($this->serviceConfig[$env][$this->port])) {
            $this->{$this->port} = $this->serviceConfig[$env][$this->port];
        }
        return $this;
    }
     ...
     *
     * @param string $port      对象属性名
     * @param string $module    API 路径
