...
class MyLogger {
    ...
    public function __construct($logFile = ""){
        $logDefaultFile = "/var/www/html/testProject/php/log/default/".date('Ymd').".log";
        $this->logFile = !empty($logFile) ? "/var/www/html/testProject/php/log/".$logFile."_".date('Ymd').".log" : $logDefaultFile;
    }
